...
var Icon$q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 225 227" }, props),
        React.createElement("image", { width: "225", height: "227", href: "/images/egg/logo.png" })));
};
...
var Icon$O = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 35 35" }, props),
        React.createElement("image", { width: "35", height: "35", href: '/images/menu/info.png' })));
};
...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 360 102" }, props),
        React.createElement("image", { width: "360", height: "102", href: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewWhite.png' })));
};
...
var Icon$V = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 26" }, props),
        React.createElement("image", { width: "32", height: "26", href: '/images/menu/telegram.png' })));
};
...
var Icon$Y = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 30 24" }, props),
        React.createElement("image", { width: "30", height: "24", href: '/images/menu/twitter.png' })));
};

var Icon$Z = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 29 27" }, props),
        React.createElement("image", { width: "29", height: "27", href: '/images/menu/reddit.png' })));
};
...
var Bell = function (_a) {
    var isDark = _a.isDark, props = __rest(_a, ["isDark"]);
    return (React.createElement(Svg, __assign({ viewBox: "0 0 56 68" }, props),
        React.createElement("image", { width: "56", height: "68", href: isDark ? '/images/menu/bell.png' : '/images/menu/bell.png' })));
};

var Icon$16 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        React.createElement("image", { width: "64", height: "64", href: '/images/menu/lucax.png' })));
};

var Icon$17 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        React.createElement("image", { width: "64", height: "64", href: '/images/menu/lucas.png' })));
};

var Icon$18 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        React.createElement("image", { width: "64", height: "64", href: '/images/menu/usdp.png' })));
};
...
var Icon$1b = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 31 25" }, props),
        React.createElement("image", { width: "31", height: "25", href: '/images/menu/medium.png' })));
};

var Icon$1c = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 26 26" }, props),
        React.createElement("image", { width: "26", height: "26", href: '/images/menu/instagram.png' })));
};
    ...
    return (React.createElement(Container$4, null,
        React.createElement(SocialEntry, null,
            cakePriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank" },
                React.createElement(LucaxIcon, { width: "24px", mr: "8px" }),
                React.createElement(BoldText, { color: "textSubtle", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 })),
            cakePriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank" },
                React.createElement(UsdpIcon, { width: "24px", mr: "8px" }),
                React.createElement(BoldText, { color: "textSubtle", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }))),
