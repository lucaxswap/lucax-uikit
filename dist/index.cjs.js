...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 225 227" }, props),
        React__default['default'].createElement("image", { width: "225", height: "227", href: "/images/egg/logo.png" })));
};
...
var Icon$I = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 54 41" }, props),
        React__default['default'].createElement("image", { width: "54", height: "41", href: '/images/menu/farm.png' })));
};
...
var Icon$O = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 35 35" }, props),
        React__default['default'].createElement("image", { width: "35", height: "35", href: '/images/menu/info.png' })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 360 102" }, props),
        React__default['default'].createElement("image", { width: "360", height: "102", href: isDark ? '/images/egg/LogoTextNewDark.png' : '/images/egg/LogoTextNewWhite.png' })));
};
...
var Icon$T = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 26 38" }, props),
        React__default['default'].createElement("image", { width: "26", height: "38", href: '/images/menu/staking.png' })));
};
...
var Icon$V = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 26" }, props),
        React__default['default'].createElement("image", { width: "32", height: "26", href: '/images/menu/telegram.png' })));
};
...
var Icon$Y = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 30 24" }, props),
        React__default['default'].createElement("image", { width: "30", height: "24", href: '/images/menu/twitter.png' })));
};

var Icon$Z = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 29 27" }, props),
        React__default['default'].createElement("image", { width: "29", height: "27", href: '/images/menu/reddit.png' })));
};
...
var Bell = function (_a) {
    var isDark = _a.isDark, props = __rest(_a, ["isDark"]);
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 56 68" }, props),
        React__default['default'].createElement("image", { width: "56", height: "68", href: isDark ? '/images/menu/bell.png' : '/images/menu/bell.png' })));
};

var Icon$16 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        React__default['default'].createElement("image", { width: "64", height: "64", href: '/images/menu/lucax.png' })));
};

var Icon$17 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        React__default['default'].createElement("image", { width: "64", height: "64", href: '/images/menu/lucas.png' })));
};

var Icon$18 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        React__default['default'].createElement("image", { width: "64", height: "64", href: '/images/menu/usdp.png' })));
};

var Icon$19 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 40 40" }, props),
        React__default['default'].createElement("image", { width: "40", height: "40", href: '/images/menu/launch-pool.png' })));
};

var Icon$1a = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 39 41" }, props),
        React__default['default'].createElement("image", { width: "39", height: "41", href: '/images/menu/referral.png' })));
};

var Icon$1b = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 31 25" }, props),
        React__default['default'].createElement("image", { width: "31", height: "25", href: '/images/menu/medium.png' })));
};

var Icon$1c = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 26 26" }, props),
        React__default['default'].createElement("image", { width: "26", height: "26", href: '/images/menu/instagram.png' })));
};
...
var IconModule = /*#__PURE__*/Object.freeze({
    ...
    LucasIcon: Icon$17,
    UsdpIcon: Icon$18,
    LaunchPoolIcon: Icon$19,
    ReferralIcon: Icon$1a,
    MediumIcon: Icon$1b,
    InstagramIcon: Icon$1c
});
...
var MoonIcon = Icons$1.MoonIcon, SunIcon = Icons$1.SunIcon, LucaxIcon = Icons$1.LucaxIcon, UsdpIcon = Icons$1.UsdpIcon;
...
var BoldText = styled__default['default'](Text)(templateObject_5$1 || (templateObject_5$1 = __makeTemplateObject(["\n  font-weight: 800;\n"], ["\n  font-weight: 800;\n"])));
    ...
    return (React__default['default'].createElement(Container$4, null,
        React__default['default'].createElement(SocialEntry, null,
            cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: priceLink, target: "_blank" },
                React__default['default'].createElement(LucaxIcon, { width: "24px", mr: "8px" }),
                React__default['default'].createElement(BoldText, { color: "textSubtle", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 })),
            cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: priceLink, target: "_blank" },
                React__default['default'].createElement(UsdpIcon, { width: "24px", mr: "8px" }),
                React__default['default'].createElement(BoldText, { color: "textSubtle", bold: true }, "$" + cakePriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }))),
...
var Menu = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            ...
            React__default['default'].createElement(Flex, { alignItems: "center" },
                React__default['default'].createElement(Bell, { isDark: isDark }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#c03d4b", textDisabled: "#878787", textSubtle: "#c03d4b", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
...
var light$2 = {
    background: lightColors.card,
    boxShadow: "0px 2px 12px -8px rgba(25, 19, 38, 1), 0px 1px 1px rgba(25, 19, 38, 0.05)",
